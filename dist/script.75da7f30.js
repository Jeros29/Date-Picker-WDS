...
function setupDates(selectedDate) {
  ...
  dates.forEach(function (date) {
    ...
    if (!(0, _dateFns.isSameMonth)(date, currentDate)) dateElement.classList.add('date-picker-other-month-date');
    if ((0, _dateFns.isSameDay)(date, selectedDate)) dateElement.classList.add('selected');
